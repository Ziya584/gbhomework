<?php
	...
	$fitosrbt = new PackagedGoods("Packed", 1001, "Фитосорбовит", 100, 200, 10);
	$dietSoft = new Software ("Soft", 2001, "ПО Диета", 50, $fitosrbt->sellPrice / 2, 5);
	$tea = new Goods("Unpacked", 3001, "Чай", 2, 10, 0, 5);
